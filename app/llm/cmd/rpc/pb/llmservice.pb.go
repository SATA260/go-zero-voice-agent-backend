...
func (x *ToolCallDelta) GetResult() string {
	if x != nil {
		return x.Result
	}
	return ""
...
func (x *ToolCallDelta) GetError() string {
	if x != nil {
		return x.Error
	}
	return ""
...
func (x *ToolCallDelta) GetScope() string {
	if x != nil {
		return x.Scope
	}
	return ""
...
func file_llmservice_proto_init() {
	...
	file_llmservice_proto_msgTypes[9].OneofWrappers = []any{
