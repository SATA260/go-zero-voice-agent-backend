...
pub mod llmproxy;
pub mod middleware;
// sip module removed - only WebRTC and WebSocket calls supported
#[cfg(test)]
mod tests;
pub mod webrtc;
pub use handler::router;
// SipOption import removed - only WebRTC and WebSocket calls supported
...
pub struct CallOption {
    ...
    // sip option removed - only WebRTC and WebSocket calls supported
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl Default for CallOption {
    fn default() -> Self {
        Self {
            ...
            enable_ipv6: None,
            // sip removed - only WebRTC and WebSocket calls supported
            extra: None,
            codec: None,
            eou: None,
        }
